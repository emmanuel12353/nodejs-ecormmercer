...
function clean() {
    ...
    for (let index = 0; index < products.length; index++){
        ...
        total =  total+parseInt(prosducts[index].price);
    }
       ...
       <th scope="col"></th>
         ...
         <th scope="col">
           <form id="form1" action="/cart" method="POST" autocomplete="off">
            ...
            <button id="submitbtn" class="btn text-white btn-success">
               buy
            </button>
           </form>
         </th>
...
document.getElementById('submitbtn').addEventListener('onClick', ()=>{
    localStorage.clear();
    setTimeout(() => {
        sub();
    }, 5000);
